...
<div class="container-fluid px-4">
    <div class="d-flex mt-4">
        ...
        <a href="paramedik_create.php" class="btn btn-primary">
           <i class="fa fa-plus"></i> Paramedik
        </a>
    </div>
    ...
    <table class="table mt-4">
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                    <a href="paramedik_edit.php?id=<?= $paramedik['id'] ?>" class="btn btn-primary"><i class="fas fa-pen-to-square"></i></a>
                    <a href="paramedik_delete.php?id=<?= $paramedik['id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
                </td>
            </tr>
