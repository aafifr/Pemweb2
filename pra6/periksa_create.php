...
<div class="container-fluid px-4">
    ...
    <form action="periksa_store.php" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <input id="pasien_id" name="pasien_id" type="text" class="form-control" required="required">
            </div>
        </div>
        <div class="form-group row">
            <label for="dokter_id" class="col-4 col-form-label">Dokter</label>
            <div class="col-8">
                <input id="dokter_id" name="dokter_id" type="text" class="form-control" required="required">
            </div>
        </div>
        <div class="form-group row">
